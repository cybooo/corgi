...
public class EmoteList {
     ...
     */
    public static final String EMOTE_HYPESQUAD = "<:hypesquad:860443290608730123>";
    public static final String EMOTE_PARTNER = "<:partner:860443290741899284>";
    public static final String EMOTE_NITRO = "<:nitro:860443290741899285>";
    public static final String EMOTE_BOT = "<:bot:860443290747142194>";

    /*
        Random Emote
     */
    public static final String THINKING_1 = "<:ThinkKing:860443290695630878>";
    public static final String THINKING_2 = "<:ThinkingPlant:860443290645037096>";
    public static final String THINKING_3 = "<:thinkingPeach:860443290310410241>";
    public static final String VERIIM = "<:FeelsVeriimMan:860443290561019955>";
    public static final String FEELSSEXMAN = "<:FeelsSexMan:860443290179731458>";
    public static final String FEELSOMGYOU = "<:FeelsYouOMG:860443290343833611>";
    public static final String FEELSSTALKERMAN = "<:FeelsStalkerMan:860443290531659806>";
